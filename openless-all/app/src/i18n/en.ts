...
export const en: typeof zhCN = {
  ...
  onboarding: {
    ...
    actionRestart: 'Reset Accessibility and Restart ZeroType',
    actionGrant: 'Grant',
    actionRequestMic: 'Request access',
    accessibilityHint: 'After granting, you must **fully quit ZeroType** and reopen it (a macOS TCC requirement).',
    footerHint: 'This onboarding closes automatically once both permissions are granted. If it persists, quit ZeroType from the menu bar and relaunch.',
    ...
    androidSteps: {
      ...
      microphoneDesc: 'Show the Android system permission sheet and allow ZeroType to record voice.',
      ...
      overlayPermissionDesc: 'Allow ZeroType to show the recording control over other apps.',
  ...
  style: {
    ...
    pack: {
      ...
      runtimeTitle: 'ZeroType Runtime Directives',
  ...
  settings: {
    ...
    recording: {
      ...
      windowsShowOpenlessInKeyboardListLabel: 'Show ZeroType in keyboard list',
      windowsShowOpenlessInKeyboardListDesc: 'When off, Win+Space will not cycle to ZeroType. SendInput insertion is unaffected. Turn this back on to restore the entry.',
      windowsShowOpenlessInKeyboardListError: 'Could not update the keyboard list: ZeroType TSF IME is not installed or the system rejected the change.',
      ...
      startupAtBootDesc: 'Start ZeroType automatically when you sign in.',
    ...
    providers: {
      ...
      codexOAuthNotice: 'Codex OAuth uses the local Codex login state (~/.codex/auth.json). ZeroType does not store an API key or Base URL for this provider.',
      ...
      bailianModelRecordedFileHint: 'Recorded-file model · transcribes after you finish (single clip ≤ 5 min).',
      appIdLabel: 'App ID',
    ...
    permissions: {
      title: 'Permissions',
      descAcc: 'ZeroType needs the following system permissions to work. After granting, fully quit and relaunch the app for changes to take effect.',
      descNoAcc: 'ZeroType needs microphone access and uses the global hotkey listener state to verify the native hook is running.',
      micLabel: 'Microphone',
      micDesc: 'Used to capture your voice input.',
      ...
      windowsImeDesc: 'Temporarily switches to the ZeroType TSF IME during voice sessions to avoid clipboard insertion limits.',
      ...
      windowsIme: {
        installed: 'Installed. Voice input temporarily switches to the ZeroType IME.',
        notInstalled: 'Not installed. ZeroType is using the clipboard/WM_PASTE fallback.',
        registrationBroken: 'Registration is broken. Reinstall the ZeroType IME.',
    ...
    about: {
      ...
      updateDialog: {
        available: {
          ...
          desc: 'ZeroType {{version}} is available. Update now?',
        },
        downloading: {
          title: 'Downloading update',
          desc: 'Downloading ZeroType {{version}}. Keep the app open.',
        },
        downloaded: {
          title: 'Update ready',
          desc: 'ZeroType {{version}} has been installed. Restart automatically now to apply it?',
        },
        installing: {
          title: 'Installing update',
          desc: 'Installing ZeroType {{version}}. Keep the app open.',
        },
        install: 'Update now',
        androidInstall: 'Download and open installer',
        androidInstalled: {
          title: 'System installer opened',
          desc: 'Follow the system prompts to finish installing. Reopen ZeroType to use {{version}}.',
        },
  ...
  localAsr: {
    ...
    storageDesc: 'Custom storage creates ZeroType/models under the selected folder and migrates existing models. ZeroType cancels downloads and releases loaded models before moving files.',
    storageChooseTitle: 'Choose local model storage parent folder',
    storageChangeConfirm: 'Existing local models will be moved to {{path}}/ZeroType/models. Downloads will be cancelled and loaded models released first. Continue?',
