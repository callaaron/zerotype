<p align="center">
  <img src="openless-all/app/src-tauri/icons/128x128@2x.png" alt="ZeroType" width="128" height="128" />
</p>

<h1 align="center">ZeroType</h1>

<p align="center">
  <strong>智能语音输入法 · 本地优先 · 热词自学习 · 声纹识别 · 用户计费</strong>
</p>

<p align="center">
  按住快捷键说话，AI 润色后的文字直接流入光标处——<br/>
  以<em>你</em>选择的写作风格呈现。
</p>

<p align="center">
  <a href="https://github.com/callaaron/zerotype/releases/latest"><strong>下载</strong></a>
  &nbsp;·&nbsp;
...
```
zerotype/                     # git clone 后的根目录
├── openless-all/            # 应用工作区（Tauri 应用所在）
│   ├── app/                # 可运行的 Tauri 应用
...
- 在 **设置 → 词汇表** 中，内置「医疗医学」「法律」两套领域语料库，勾选并「启用所选」后，词条会作为热词同时提升 ASR 识别准确率与润色术语准确性。
